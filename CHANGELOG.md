...
- The alignment modules now report the length and number of sequences of the _target_ and _query_ genomes ([#77](https://github.com/nf-core/pairgenomealign/pull/77)).
- The GFF files now report the length of each _target_ sequences in their header ([#70](https://github.com/nf-core/pairgenomealign/pull/70)).
- Resource usage of the `last/split` module was revised from _high_ to _medium_ following benchmarks on vertebrate genomes ([#61](https://github.com/nf-core/pairgenomealign/pull/61)).
