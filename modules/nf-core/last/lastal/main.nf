process LAST_LASTAL {
    ...
    function calculate_psl_metrics() {
        awk 'BEGIN {
            ...
            totalAlignedBases = 0;
            print "Sample\tTotalAlignmentLength\tPercentSimilarity\tPercentSimilarityNogaps";  # Header for MultiQC
        }
        {
        ...
        END {
            ...
            percentSimilarityNogaps = (totalAlignmentLength > 0) ? (totalMatches / totalAlignedBases    * 100) : 0;
            print "$meta.id" "\t" totalAlignmentLength "\t" percentSimilarity "\t" percentSimilarityNogaps;  # Data in TSV format
        }'
    }
