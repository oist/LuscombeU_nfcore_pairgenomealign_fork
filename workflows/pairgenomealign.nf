...
include { LAST_MAFCONVERT as ALIGNMENT_CONVERT } from '../modules/nf-core/last/mafconvert/main'
...
workflow PAIRGENOMEALIGN {
    ...
    if (!(params.convert_to == "no")) {
        ALIGNMENT_CONVERT(pairalign_out.o2o, params.convert_to)
    }
